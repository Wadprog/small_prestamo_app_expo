...
const DrawerNav = () => {
  ...
  <Drawer.Navigator
    screenOptions={{
      ...
      headerRight:(props)=>(
      <TouchableOpacity onPress={()=>console.log(navigation)} style={tw` p-1 flex flex-row bg-blue-100 justify-center `}>
     <Image source={require('../assets/images/log.png')} style={{width: 20, height: 20}}/>
